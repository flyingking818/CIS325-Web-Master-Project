...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <!--hint: add a drop down and allows user to select search method: by name, by id, by blah... -->
    <!-- add a method to perform the search using the WHERE clause, exact =, fuzzy/approximate search 'like %keyword%' -->
